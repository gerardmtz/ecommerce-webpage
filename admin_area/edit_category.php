...
if(isset($_POST['edit_cat'])){
    ...
    if($result_cat){
        echo "<script>alert('La categoria se ha actualizado correctamente')</script>";
...
<form action="" method="post" class="text-center">
    <div class="form-outline mb-4 w-50 m-auto">
        <label for="category_title" class="category_title">Titulo de la Categoria</label>
        <input type="text" name="category_title" id="category_title" class="form-control" required="requerid" value="<?php echo $category_title;?>">
    </div>
