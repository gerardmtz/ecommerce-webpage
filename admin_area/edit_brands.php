...
if(isset($_POST['edit_brand'])){
    ...
    if($result_brand){
        echo "<script>alert('La Marca se ha actualizado correctamente')</script>";
...
<form action="" method="post" class="text-center">
    <div class="form-outline mb-4 w-50 m-auto">
        <label for="brand_title" class="category_title">Titulo de la Categoria</label>
        <input type="text" name="brand_title" id="brand_title" class="form-control" required="requerid" value="<?php echo $brand_title;?>">
    </div>
